...
namespace PasswordTextBoxControl.Facades
{
    ...
    public class Timer : ITimer
    {
        ...
        /// <summary>
        /// Indicates whether the <see cref="Timer"/> should raise the
        ...
        /// <summary>
        /// Disposes resources acquired by the <see cref="Timer"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes unmanaged resources acquired by the <see cref="Timer"/>,
