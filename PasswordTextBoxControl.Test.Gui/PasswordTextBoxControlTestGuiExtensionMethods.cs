...
namespace PasswordTextBoxControl.Test.Gui
{
    public static class PasswordTextBoxControlTestGuiExtensionMethods
    {
        ...
        /// </remarks>
        public static int GetCaretIndex(this TextBoxBase @this, int x, int y)
        {
            return @this.GetCaretIndex(new Point(x, y));
        }
        ...
        /// the end). See http://stackoverflow.com/a/3874132.
        /// </remarks>
        public static int GetCaretIndex(this TextBoxBase @this, Point point)
        {
